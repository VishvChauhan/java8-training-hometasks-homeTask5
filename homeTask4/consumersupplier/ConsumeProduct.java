...
public class ConsumeProduct {
	...
	public static void main(String[] args) {
		...
		// Given a product write a consumer to print the product to appropriate medium
		// depending on the print parameter.
		// If the print parameter is set to file, consumer shall log the product to
		// file, if not print on the console.
